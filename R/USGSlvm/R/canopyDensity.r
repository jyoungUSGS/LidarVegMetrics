...
#'
#'@usage canopyDensity(x, resolution = 30, pointClasses = c(3,4,5))
#'
...
#'@examples
#'
#' canopyDensityRaster <- canopyDensity(lasdata)
#'
#'@export
#'@importFrom raster raster rasterize

canopyDensity <- function(x, resolution = 30, pointClasses = c(3,4,5)) {
